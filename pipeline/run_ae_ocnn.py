...
def run_pipeline(cfg: Config) -> None:
    ...
    # Run dirs
    # -------------------------
    mode_tag = f"{cfg.ae_mode}_{'joint' if cfg.ocnn_joint else 'zonly'}"
    run_name = make_run_name(model=mode_tag, digit=cfg.normal_digit, nu=cfg.nu)
    ...
    #ae_ckpt_path = "runs/rcae_joint_digit0_nu0.01_20260129_180504/20260129_180504/checkpoints/ae_rcae.pt"
    # ============================================================
    ...
    if cfg.ocnn_joint:
        ...
        ocnn, _enc_used, r_star, ocnn_hist = train_ocnn(
            ...
            clip_norm=cfg.svdd_clip_norm if hasattr(cfg, "svdd_clip_norm") else 0.5,
        )
    else:
    ...
    # Plot extremes within the same class (e.g., normals only)
